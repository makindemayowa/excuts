  ...
  <div class="panel" style="width: 80%; margin: 0px auto;">
    ...
    <div class="panel-body" style="background-color: #ffffff; padding: 25px; margin-bottom: 25px; color: #303030; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px; border: 1px solid #dddddd;">
      <p>Someone requested a password reset for your Bilimoda account. If this was not you, please disregard this email. Otherwise, click the button below to choose a new password:</p>
       <a style="background-color: #38807b; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; border-radius: 12px; margin-left: 30%;" href="<%= link %>" >Reset Password </a>
      <p>Sincerely,</p>
      <p>The Bilimoda Team</p>
    </div>
    <div class="panel-footer" style="text-align: center; background-color: #f3f3f3;">
      <p style="color: #787878; font-size: 11px;">Please do not reply to this email. To get in touch with us, visit our <a style="color: #00B7D8;" href=""> help center.</a> <br>If you did not sign up for an Bilimoda account, please disregard this message.</p>
    </div>
  </div>
</div>`
};
